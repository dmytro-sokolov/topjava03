# Занятие 9 онлайн проекта <a href="http://javawebinar.ru/topjava/">Topjava</a>
...
## Домашнее задание HW9
    ...
    вернуть LoggedUser.id() с авторизацией и добавить авторизацию в UserMeals тесты
    сделать тест на неавторизованный доступ;
